...
public final class AllDataQuery: GraphQLQuery {
  ...
  public let operationName: String = "AllData"
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct DailyTransactionsFeed: GraphQLSelectionSet {
      public static let possibleTypes: [String] = ["DaySectionWidget", "TransactionWidget"]
      ...
      public struct AsDaySectionWidget: GraphQLSelectionSet {
        public static let possibleTypes: [String] = ["DaySectionWidget"]
      ...
      public struct AsTransactionWidget: GraphQLSelectionSet {
        public static let possibleTypes: [String] = ["TransactionWidget"]
